...
class _ProfileState extends State<Profile> {
  ...
  void _submit(dynamic jsondata, dynamic decksdata, BuildContext context) async {
    setState(() => _saving = true);

    final url = Uri.parse('https://crproxy-production-6a8c.up.railway.app/calculate');
  ...
  Widget build(BuildContext context) {
    final decksdata = json.decode(widget.responseDecks.body);
    final jsondata = json.decode(widget.responsePlayer.body);
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                SizedBox(width: cardsToUpgrade.isEmpty ? 10 : 0),
                Flexible(
                  child: (Text(
                    softWrap: true,
            ...
            SizedBox(height: 150),
            ElevatedButton(
              onPressed: () => _submit(jsondata, decksdata, context),
              style: ButtonStyle(
